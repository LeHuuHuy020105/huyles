      ...
      <div class="new_store">
        ...
        <p class="wrapper__store--body">
          ...
          <div class="address_img">
            <img src="./img/collection_pannel.jpg" alt="">
          </div>
        <p class="wrapper__store--body">  
...
function showEventAnniversary() {
  ...
  document.querySelector(".contact_section").innerHTML = `
      <div class="event">
        ...
        <div class="event_img">
          <img src="./img/5_6a53e98b-c3e8-404d-b918-fe35a17f663d.webp" alt="">
        </div>
        <p class="wrapper__store--body">
        ...
        <div class="event_img">
          <img src="./img/7_bca44536-ba35-4822-bbc2-3c38d0050951.webp" alt="">
        </div>
        <p class="wrapper__store--body">
        ...
        <div class="event_img">
          <img src="./img/9_88e7e1e2-41ee-4ef6-99ee-0fcd0aa9f4f8.webp" alt="">
        </div>
        <p class="wrapper__store--body">
